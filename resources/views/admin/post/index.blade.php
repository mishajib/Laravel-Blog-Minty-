                                    ...
                                    @foreach($posts as $key => $post)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if($post->is_approved == true)
                                                    <button type="button" class="btn btn-success waves-effect" onclick="pendingPost({{ $post->id }})">
                                                        <i style="font-size: 15px;" class="material-icons">done</i>
                                                    </button>
                                                    <form action="{{ route('admin.post.approve', $post->id) }}" id="approve-form" style="display: none;" method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                    </form>
                                                @endif
                                                ...
                                                <a href="{{ route('admin.post.show', $post->id) }}" class="btn btn-success btn-sm waves-effect">
                                                    <i style="font-size: 15px;" class="material-icons">visibility</i>
                                                </a>

                                                <a href="{{ route('admin.post.edit', $post->id) }}" class="btn btn-info btn-sm waves-effect">
                                                    <i style="font-size: 15px;" class="material-icons">edit</i>
                                                </a>
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        function pendingPost(id) {
            ...
            swalWithBootstrapButtons.fire({
                title: 'Are you sure?',
                text: "You wanted to pending this post!",
                type: 'warning',
                showCancelButton: true,
