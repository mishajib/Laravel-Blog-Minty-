                                            ...
                                            <td class="text-center">
                                                @if($post->is_approved == false)
                                                    <button type="button" class="btn btn-success waves-effect" onclick="approvePost({{ $post->id }})">
                                                        <i style="font-size: 9px;" class="material-icons">done</i>
                                                    </button>
                                                ...
                                                <a href="{{ route('admin.post.show', $post->id) }}" class="btn btn-success btn-sm waves-effect">
                                                    <i style="font-size: 9px;" class="material-icons">visibility</i>
                                                </a>

                                                <a href="{{ route('admin.post.edit', $post->id) }}" class="btn btn-info btn-sm waves-effect">
                                                    <i style="font-size: 9px;" class="material-icons">edit</i>
                                                </a>

                                                <button onclick="deletePost({{ $post->id }})" class="btn btn-danger waves-effect" type="button">
                                                    <i style="font-size: 9px;" class="material-icons">delete</i>
                                                </button>
