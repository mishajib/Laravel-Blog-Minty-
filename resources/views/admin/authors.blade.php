                ...
                <div class="card">
                    <div class="header">
                        <h2>
                            ...
                            <span class="badge bg-amber">{{ $authors->count() }}</span>
                        </h2>
                                    ...
                                    @foreach($authors as $key => $author)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button onclick="deleteAuthor({{ $author->id }})" class="btn btn-danger waves-effect" type="button">
