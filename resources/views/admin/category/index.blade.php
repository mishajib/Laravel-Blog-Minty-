                ...
                <div class="card">
                    <div class="header">
                        <h2>
                            ...
                            <span class="badge bg-amber">{{ $categories->count() }}</span>
                        </h2>
                                ...
                                <tbody>
                                    @foreach($categories as $key => $category)
                                        <tr>
                                            ...
                                            <td><img class="img-responsive" height="100" width="100" src="{{ asset('storage/category/slider/'.$category->image) }}" alt="{{ $category->name }}"></td>
