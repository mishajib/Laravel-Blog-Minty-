...
@section('site-title', 'Category By Post')
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card h-auto">
                                <div class="single-post post-style-1">
                                    ...
                                    <a class="avatar" href="{{ route('author.profile', $post->user->id) }}"><img
                                    ...
                                    <div class="blog-info">
                                        ...
                                        <ul class="post-footer">
                                            <li>
                                                ...
                                                @else
                                                    <a onclick="document.getElementById('favourite-form-{{ $post->id }}').submit();"
                                                       href="javascript:void(0);"
                                                       class="{{ !Auth::user()->favourite_posts->where('pivot.post_id',$post->id)->count() == 0 ? 'favourite-post' : '' }}">
                                                        <i class="ion-heart"></i>{{ $post->favourite_to_users->count() }}
                                                    </a>
                                                    <form id="favourite-form-{{ $post->id }}"
                                                          action="{{ route('post.favourite',$post->id) }}" method="POST"
                                                          style="display: none;">
                                                        @csrf
